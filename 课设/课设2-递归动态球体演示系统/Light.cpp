...
{
	this->L_Position.x=L_R*sin(L_Phi*PI/180)*sin(L_Theta*PI/180);
	this->L_Position.z=L_R*sin(L_Phi*PI/180)*cos(L_Theta*PI/180);	
	this->L_Position.y=L_R*cos(L_Phi*PI/180);
}